...
const handleIconSuccess: UploadProps["onSuccess"] = (response, uploadFile) => {
  ...
  addApplicationModal.value.formState.icon = URL.createObjectURL(
    uploadFile.raw!
  );
};
/**
    ...
    <template #default>
      ...
      >
        <el-form-item label="应用名称：" prop="name">
          <el-input
            v-model="addApplicationModal.formState.name"
            placeholder="请输入应用名称"
          />
        </el-form-item>
          ...
          >
            <template #default>
              ...
              <div v-else class="up-slot">
                <img
                  alt=""
                  class="upload-icon"
                  src="@/assets/img/plugin/upload.png"
                />
            ...
            <template #tip>
              <div class="el-upload__tip">
                比例1:1，至少60*60像素，支持jpg/jpeg/png格式，限制1M
              </div>
            </template>
          </el-upload>
        </el-form-item>
          ...
          >
            <template #default>
              <div class="up-slot">
                <img
                  alt=""
                  class="upload-icon-plus"
                  src="@/assets/img/plugin/plus.png"
                />
