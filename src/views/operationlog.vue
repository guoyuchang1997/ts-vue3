<template>
  ...
  <div class="operationlog">
      ...
      <el-table :data="tableData" style="width: 100%" height="100%">
        ...
        <el-table-column prop="loginTime" label="详情">
          <template #default="{ row }">
            <span class="login" @click="showDetails(row)">查看详情</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <!-- 查看详情模态框 -->
    <el-dialog v-model="isShowDetails" width="700px" :show-close="false" destroy-on-close>
      <Details>
        <DialogTitle title="操作详情" @close="showDetails" />
      </Details>
    </el-dialog>
  </div>
</template>
...
import Details from '@/components/operationlog/Details.vue'
