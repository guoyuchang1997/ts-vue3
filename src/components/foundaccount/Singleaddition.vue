    ...
    <div class="left">
      ...
      <div class="input">
        <div class="conten">
          ...
          <div class="beizhu">
            <span class="width">备注</span><el-input v-model="from.remark" type="textarea" show-word-limit></el-input>
          </div>
          <div class="beizhu">
            <span class="width">Cookie</span
            ><el-input
              v-model="from.Cookie"
              type="textarea"
              show-word-limit
              placeholder="支持JSON/Netscape/Name=Value格式的Cookie"
            ></el-input>
            <span @click="Cookielist.push({ Cookie: '' })" class="floatright ellipsis"
              ><i class="iconfont icon-yuanquanjiahao"></i>添加其他Cookie</span
            >
          </div>
          <div class="Cookieheight">
            <div v-for="(i, index) in Cookielist" :key="index" class="beizhu">
              <span class="width">其他Cookie</span
              ><el-input
                v-model="i.Cookie"
                type="textarea"
                show-word-limit
                placeholder="支持JSON/Netscape/Name=Value格式的Cookie"
              ></el-input>
              <span @click="Cookielist.splice(index, 1)" class="floatright floatrights"
                ><i class="iconfont icon-shanchu fs-xxl"></i
              ></span>
            </div>
          </div>
          <div class="beizhu">
